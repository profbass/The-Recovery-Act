...
$(document).ready(function(){$('#nav').localScroll(800);$('#home').parallax("50%",0.1);$('#about').parallax("50%",0.2);$('#signup').parallax("50%",0.3);$('#shows').parallax("50%",0.5);$('.bg').parallax("175%",0.4);});
